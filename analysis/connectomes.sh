...
for dir in ${fba}/data/sub-*; do
  ...
  for ses in ses-01 ses-02 ses-03; do
    ...
    # 5tt-generation
    5ttgen fsl ${der}/anat/${sub}_${ses}_acq-T1w_brain.nii.gz ${dir}/ACT/${sub}_5tt.mif -nocrop -premasked -force
    ...
    tcksift2 ${fba_sdir}/ACT/${sub}.tck ${fba_sdir}/${sub}_wmfod_norm.mif ${fba_sdir}/ACT/${sub}_weights.txt \
    -act ${fba_sdir}/ACT/${sub}_5tt.mif -fd_scale_gm -out_mu ${fba_sdir}/ACT/${sub}_pc_mu.txt -force

    # Reformat schaefer parcellation
    labelconvert \
    ${s_dwi}/parcellations/${sub}_Schaefer2018_400Parcels_7Networks_space-dwi.nii.gz \
